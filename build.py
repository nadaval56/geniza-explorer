...
<body>
  ...
  <header class="site-header">
    <div class="header-inner">
      ...
      <p class="site-intro">
        בכנסייה הקטנה של בן עזרא בקהיר העתיקה נשמרו, כמעט בנס, {total_docs:,} מסמכים יהודיים — אוצרות שלא נועדו לעיני זרים.
        במשך למעלה מתשע מאות שנה הצטברו בה דפים נושאי שם ה׳ שאסור היה להשמידם:
        פסקי הלכה ותפילות, שטרי מסחר וכתבי אהבה, פנקסי קהילה ומכתבי יתומים.
        מתוך אבק הדורות עולים קולותיהם של חיים יהודיים שלמים, על קודשם וחולם.
      </p>
